...
regions_simple_shp = os.path.abspath(os.path.join('geodjango', 'data', 'regions_simple2.shp'))


def run_regions_simple(verbose=True):
    lm_rs = LayerMapping(regions_simple, regions_simple_shp, regions_simple_mapping,
                      transform=False, encoding='iso-8859-1')

    lm_rs.save(strict=True, verbose=verbose)