...
# regions2_shp = os.path.abspath(os.path.join('geodjango', 'data', 'merged', 'regions_shp.shp'))


# def run(verbose=True):
#     lm = LayerMapping(regions2, regions2_shp, regions2_mapping,
...
districts_shp = os.path.abspath(os.path.join('geodjango', 'data', 'merged', 'districts_shp.shp'))


def run(verbose=True):
    lm = LayerMapping(districts, districts_shp, districts_mapping,
                      transform=False, encoding='iso-8859-1')
